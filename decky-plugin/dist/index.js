...
/** Compact stat row */
const StatRow = ({ label, value, color = C.textDim, }) => (SP_JSX.jsxs("div", { style: {
        display: "flex",
        justifyContent: "space-between",
        alignItems: "center",
        padding: "4px 0",
    }, children: [SP_JSX.jsx("span", { style: { fontSize: 12, color: C.textDim }, children: label }), SP_JSX.jsx("span", { style: { fontSize: 13, color, fontWeight: 600 }, children: value })] }));
...
const HPBar = ({ name, hp, maxHp, isHost = false }) => {
    ...
    return (SP_JSX.jsxs("div", { style: { marginBottom: isHost ? 8 : 5 }, children: [SP_JSX.jsxs("div", { style: {
                    display: "flex",
                    justifyContent: "space-between",
                    alignItems: "baseline",
                    marginBottom: 3,
                        ...
                        }, children: name }), SP_JSX.jsxs("span", { style: {
                            fontSize: isHost ? 12 : 10,
                            color,
                            fontWeight: 600,
                            fontVariantNumeric: "tabular-nums",
                        }, children: [hp, "/", maxHp] })] }), SP_JSX.jsx("div", { style: {
                    height: isHost ? 8 : 5,
...
/** Divider */
const Divider = () => (SP_JSX.jsx("div", { style: {
        height: 1,
...
const TadpolePanel = () => {
    ...
    return (SP_JSX.jsxs("div", { style: { padding: "4px 0" }, children: [nodeMissing && (SP_JSX.jsx(DFL.PanelSection, { title: "", children: SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: {
                            padding: "10px 12px",
                            borderRadius: 8,
                            ...
                            fontSize: 12,
                            lineHeight: 1.5,
                        }, children: [SP_JSX.jsx("strong", { children: "Node.js required." }), SP_JSX.jsx("br", {}), "Install in Desktop Mode:", SP_JSX.jsx("br", {}), SP_JSX.jsx("code", { style: { color: C.accent, fontSize: 11 }, children: "sudo pacman -S nodejs npm" })] }) }) })), SP_JSX.jsxs(DFL.PanelSection, { title: "", children: [SP_JSX.jsx(SectionHeader, { title: "Connection", icon: "\uD83D\uDD17" }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: {
                                display: "flex",
                                justifyContent: "space-between",
                                alignItems: "center",
                            }, children: [SP_JSX.jsx(StatusBadge, { label: bridgeRunning ? "Bridge Active" : "Bridge Offline", active: bridgeRunning }), bridgeRunning && connectedClients > 0 && (SP_JSX.jsx(Pill, { label: `${connectedClients} phone${connectedClients !== 1 ? "s" : ""}`, color: C.green }))] }) }), bridgeRunning && (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: {
                                padding: "6px 10px",
                                borderRadius: 6,
                                backgroundColor: C.surface,
                            ...
                            }, children: [ip, ":", settings.port] }) })), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", disabled: loading || nodeMissing, onClick: bridgeRunning ? stopBridge : startBridge, children: SP_JSX.jsxs("span", { style: {
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                    gap: 6,
                                }, children: [loading ? "⟳" : bridgeRunning ? "■" : "▶", loading ? "Working..." : bridgeRunning ? "Stop Bridge" : "Start Bridge"] }) }) })] }), SP_JSX.jsxs(DFL.PanelSection, { title: "", children: [SP_JSX.jsx(SectionHeader, { title: "Game", icon: "\uD83C\uDFAE" }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(StatusBadge, { label: bg3Running ? "BG3 Running" : "BG3 Not Detected", active: bg3Running, activeColor: C.accent, inactiveColor: C.textDim }) }), !bg3Running && (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: {
                                padding: "8px 12px",
                                borderRadius: 8,
                                backgroundColor: C.surface,
                                fontSize: 11,
                                ...
                                padding: "6px 0",
                                                ...
                                                letterSpacing: 0.8,
                                                marginBottom: 4,
                                            }, children: "Recent" }), SP_JSX.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 3 }, children: recentEvents.slice(-5).reverse().map((evt, i) => (SP_JSX.jsxs("div", { style: {
                                                    display: "flex",
                                                    alignItems: "center",
                                                    gap: 6,
                                                    fontSize: 11,
                                                }, children: [SP_JSX.jsx("span", { style: { fontSize: 12 }, children: EVENT_ICONS[evt.type] || "•" }), SP_JSX.jsxs("span", { style: { color: C.textDim, flex: 1 }, children: [evt.type.replace(/_/g, " "), evt.detail ? ` — ${evt.detail}` : ""] })] }, i))) })] }) })] }))] })), SP_JSX.jsxs(DFL.PanelSection, { title: "", children: [SP_JSX.jsx(SectionHeader, { title: "Phone App", icon: "\uD83D\uDCF1" }), SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: {
                                padding: "10px 12px",
                                borderRadius: 8,
                                backgroundColor: C.surface,
                                border: `1px solid ${C.border}`,
